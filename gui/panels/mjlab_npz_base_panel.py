...
class MjlabNpzBasePanel(BasePanel):
    """MJLab NPZ → CSV（仅 base body）：只提取第 0 个刚体数据，输出 61 列 CSV。"""

    PANEL_TITLE = "MJLab NPZ→CSV"
    PANEL_GROUP = "Import"
    ...
    def _execute(self, params: dict):
        from mjlab_beyondmimic_npz2csv_no_estimate import export_all_to_one_csv
